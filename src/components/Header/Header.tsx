      ...
      <div className='container'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='w-6 h-6 mr-2 flex-shrink-0'>
                <img
                  src='https://cdn.oneesports.vn/cdn-data/sites/4/2023/08/One-Piece-Gear-5-1024x576.jpg'
                  alt='avatar'
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-8 fill-white w-full lg:h-11'>
              <g fillRule='evenodd'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='bg-white rounded-sm p-1 flex'>
              <input
                type='text'
                placeholder='FREESHIP CHO ĐƠN TỪ 0Đ'
                      ...
                      <div className='mt-5'>
                        <div className='mt-4 flex'>
                          <div className='flex-shrink-0'>
                            <img
                              src='https://chupanh.vn/wp-content/uploads/2017/04/cach-chup-anh-do-gia-dung-dep.jpg'
                              alt='anh'
                              className='w-11 h-11 object-cover'
                            />
                          </div>
                          <div className='flex-grow ml-2 overflow-hidden'>
                            <div className='truncate'>Nồi xịn nhật bản sale giá siêu hời ...</div>
                          </div>
                          <div className='ml-2 flex-shrink-0'>
                            <span className='text-orange'>460.000Đ</span>
                          </div>
                        </div>
                        <div className='mt-4 flex'>
                          <div className='flex-shrink-0'>
